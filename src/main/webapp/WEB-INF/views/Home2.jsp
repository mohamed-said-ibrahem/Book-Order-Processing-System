...
<body>
        ...
        <div class="main-menu">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="resources/Theme2/html/index.html"><img src="resources/Theme2/html/images/logo.png" alt="logo"></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            <li class="navbar-item active">
                                <a href="resources/Theme2/html/index.html" class="nav-link">Home</a>
                            </li>
                            <li class="navbar-item">
                                <a href="resources/Theme2/html/shop.html" class="nav-link">Shop</a>
                            </li>
                            <li class="navbar-item">
                                <a href="resources/Theme2/html/about.html" class="nav-link">About</a>
                            </li>
                            <li class="navbar-item">
                                <a href="resources/Theme2/html/faq.html" class="nav-link">FAQ</a>
                            </li>
                            <li class="navbar-item">
                                <a href="resources/Theme2/html/login.html" class="nav-link">Login</a>
                            </li>
                        </ul>
    ...
    <section class="slider">
        <div class="container">
            <div id="owl-demo" class="owl-carousel owl-theme">
                <div class="item">
                    <div class="slide">
                        <img src="resources/Theme2/html/images/slide1.jpg" alt="slide1">
                        <div class="content">
                            <div class="title">
                ...
                <div class="item">
                    <div class="slide">
                        <img src="resources/Theme2/html/images/slide2.jpg" alt="slide1">
                        <div class="content">
                            <div class="title">
                                <h3>welcome to bookstore</h3>
                                <h5>Discover the best books online with us</h5>
                ...
                <div class="item">
                    <div class="slide">
                        <img src="resources/Theme2/html/images/slide3.jpg" alt="slide1">
                        <div class="content">
                            <div class="title">
                                <h3>welcome to bookstore</h3>
                                <h5>Discover the best books online with us</h5>
                ...
                <div class="item">
                    <div class="slide">
                        <img src="resources/Theme2/html/images/slide4.jpg" alt="slide1">
                        <div class="content">
                            <div class="title">
                                <h3>welcome to bookstore</h3>
                                <h5>Discover the best books online with us</h5>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        <img src="resources/Theme2/html/images/img1.jpg" alt="img">
                        <h3>how to be a bwase</h3>
                        <h6><span class="price">$49</span> / <a href="#">Buy Now</a></h6>
                        <div class="hover">
                            <a href="resources/Theme2/html/product-single.html">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        <img src="resources/Theme2/html/images/img2.jpg" alt="img">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        <img src="resources/Theme2/html/images/img3.jpg" alt="img">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        <img src="resources/Theme2/html/images/img4.jpg" alt="img">
                        <h3>wendy doniger</h3>
                        <h6><span class="price">$49</span> / <a href="#">Buy Now</a></h6>
                        <div class="hover">
                            <a href="resources/Theme2/html/product-single.html">
    ...
    <section class="about-sec">
        ...
        <div class="about-content">
            ...
            <div class="btn-sec">
                <a href="resources/Theme2/html/shop.html" class="btn yellow">shop books</a>
                <a href="resources/Theme2/html/login.html" class="btn black">subscriptions</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <img src="resources/Theme2/html/images/r1.jpg" alt="img">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <img src="resources/Theme2/html/images/r2.jpg" alt="img">
                        <h3><a href="#">Keepers of the kalachakara</a></h3>
                        <h6><span class="price">$19</span> / <a href="#">Buy Now</a></h6>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <img src="resources/Theme2/html/images/r3.jpg" alt="img">
                        <h3><a href="#">Keepers of the kalachakara</a></h3>
                        <h6><span class="price">$19</span> / <a href="#">Buy Now</a></h6>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <img src="resources/Theme2/html/images/r4.jpg" alt="img">
                        <h3><a href="#">Keepers of the kalachakara</a></h3>
                        <h6><span class="price">$19</span> / <a href="#">Buy Now</a></h6>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <img src="resources/Theme2/html/images/r5.jpg" alt="img">
                        <h3><a href="#">Keepers of the kalachakara</a></h3>
                        <h6><span class="price">$19</span> / <a href="#">Buy Now</a></h6>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    on selected books go and shop them</h6>
                        <a href="resources/Theme2/html/products.html" class="btn blue-btn">view all books</a>
                        <span class="icon-point percentage">
                            <img src="resources/Theme2/html/images/precentagae.png" alt="">
                        </span>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    on selected books go and shop them</h6>
                        <a href="resources/Theme2/html/products.html" class="btn blue-btn">view all books</a>
                        <span class="icon-point amount"><img src="resources/Theme2/html/images/amount.png" alt=""></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="testimonial-sec">
        ...
        <div class="left-quote">
            <img src="resources/Theme2/html/images/left-quote.png" alt="quote">
        </div>
        <div class="right-quote">
            <img src="resources/Theme2/html/images/right-quote.png" alt="quote">
        </div>
    </section>
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="navigation">
                        <h4>Navigation</h4>
                        <ul>
                            <li><a href="resources/Theme2/html/index.html">Home</a></li>
                            <li><a href="resources/Theme2/html/about.html">About Us</a></li>
                            <li><a href="resources/Theme2/html/privacy-policy.html">Privacy Policy</a></li>
                            <li><a href="resources/Theme2/html/terms-conditions.html">Terms</a></li>
                            <li><a href="resources/Theme2/html/products.html">Products</a></li>
                        </ul>
                    </div>
                    <div class="navigation">
                        <h4>Help</h4>
                        <ul>
                            ...
                            <li><a href="resources/Theme2/html/privacy-policy.html">Privacy</a></li>
                            <li><a href="resources/Theme2/html/faq.html">FAQ’s</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-5">
    ...
    <script src="resources/Theme2/html/js/jquery.min.js"></script>
    <script src="resources/Theme2/html/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="js/owl.carousel.min.js"></script>
    <script src="resources/Theme2/html/js/custom.js"></script>
</body>
