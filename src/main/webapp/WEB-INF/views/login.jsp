...
<body>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            <li class="navbar-item">
                                <a href="http://localhost:8080/registrationform/" class="nav-link">Home</a>
                            </li>
                            <li class="navbar-item">
    ...
    <div class="breadcrumb">
        <div class="container">
            <a class="breadcrumb-item" href="http://localhost:8080/registrationform/">Home</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <button class="btn black">Login</button>
                             <h5>not Registered? <a href="viewregisrationpage">REgister here</a></h5>
                        </div>
                    </div>
                </form>
            </div>      
